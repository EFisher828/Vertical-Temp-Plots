...
const chartBuilder = () => {
	...
	if(name == 'Temperature'){
		...
		variable = 'windchill'
		fullName = 'Wind Chill Temperature'
	}
...
const chartBuilderArchive = () => {
	...
	let url = `https://api.climate.ncsu.edu/data?loc=MITC,FRYI,JEFF,BEAR,LAUR,FLET&var=${variable}&start=${endTime}&end=${startTime}&obtype=O&output=json&attr=location,datetime,var,value,value_accum,unit,score,nettype,paramtype,obtype,obnum,obtime&hash=8de315acb7cf795cf0e5a4b9d351caa2efd2a922`
